...
export interface PortofolioTemplateProps {
  ...
  imageLayout?: 'horizontal' | 'wrap' // Optional: horizontal (default) atau wrap (bisa multi-baris)
}
...
const PortofolioTemplate: React.FC<PortofolioTemplateProps> = ({
  ...
  technologies,
  portfolioImages,
  imageLayout = 'horizontal', // Default: horizontal
}) => {
  return (
    <section className="w-full relative">
      ...
      <div className="relative flex flex-col w-full top-[40px] gap-[25px] justify-center items-center mb-[170px]">
        ...
        <div className={`flex ${imageLayout === 'wrap' ? 'flex-wrap' : 'flex-row'} gap-[10px] items-center justify-center`}>
